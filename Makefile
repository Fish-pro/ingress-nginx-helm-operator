...
# nginx.io/ingress-nginx-helm-operator-bundle:$VERSION and nginx.io/ingress-nginx-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= nginx.io/ingress-nginx-helm-operator
